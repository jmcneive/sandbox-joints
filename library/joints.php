...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // orphan (without media query polyfill)
    wp_register_script( 'orphan-scripts', get_template_directory_uri() . '/library/js/orphan-scripts.js', array(), '2.5.3', false );

    // waypoints (without media query polyfill)
    wp_register_script( 'waypoints-scripts', get_template_directory_uri() . '/library/js/waypoints.min.js', array(), '2.5.3', false );
    ...
    wp_enqueue_script( 'orphan-scripts' );
